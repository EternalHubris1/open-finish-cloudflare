  ...
  return (
    <div className="min-h-screen p-8 space-y-12 animate-slide-up max-w-5xl mx-auto relative z-10 pb-20">
      ...
      {activities.length === 0 ? (
        <div className="bg-[rgba(15,15,20,0.85)] backdrop-blur-xl border border-white/5 border-dashed rounded-3xl p-16 text-center shadow-2xl">
          ...
          <p className="mx-auto max-w-md text-sm leading-7 text-white/45">
            Start with one direction you want a reminder to protect. You can add
            an alert after the activity exists.
          </p>
          <Link
            href="/activities"
            className="mt-7 inline-flex h-11 items-center gap-2 rounded-full bg-[#e95448] px-6 text-[10px] font-bold uppercase tracking-[.14em] text-white transition-colors hover:bg-[#f26456]"
          >
        ...
        <div className="bg-[rgba(15,15,20,0.85)] backdrop-blur-xl border border-white/5 border-dashed rounded-3xl p-16 text-center shadow-2xl">
          ...
          <p className="mx-auto max-w-md text-sm leading-7 text-white/45 mb-8">
            Add a quiet prompt only where it will make returning easier.
          </p>
          <Button
            onClick={openCreateDialog}
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-start gap-6 flex-1">
                  <div
                    className={`p-4 rounded-3xl ${alert.enabled ? "bg-red-500/10 text-red-400 border border-red-500/30 shadow-[0_0_15px_rgba(220,38,38,0.15)]" : "bg-white/5 text-white/30 border border-white/10"}`}
                  >
                    {alert.enabled ? (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-8">
                      <div
                        className={`font-bold text-2xl tracking-wider ${alert.enabled ? "text-red-400" : "text-white/30"}`}
                      >
                        {alert.timeOfDay}
                      </div>
                          ...
                          return (
                            <span
                              ...
                              className={`w-9 h-9 flex items-center justify-center rounded-2xl text-[10px] font-bold uppercase tracking-wider transition-colors ${
                                isActive
                                  ? alert.enabled
                                    ? "bg-red-500 text-white shadow-[0_0_10px_rgba(220,38,38,0.4)]"
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent
          className="rounded-3xl border-white/10 p-8 bg-[#0a0a0a] backdrop-blur-2xl shadow-2xl"
          data-testid="dialog-delete-alert"
        >
          <AlertDialogHeader>
